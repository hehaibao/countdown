...
*/
(function(c){c.fn.countdown=function(b){function d(){this.$element=null;this.$childEl=b&&b.child||".countdown-box";this.txt=b&&b.txt||"\u8ddd\u7ed3\u675f";this.sp=b&&b.sp||":";this.isZh=b&&b.isZh||!1;this.dateValue=this.tpl="";this.timer=null}d.prototype={init:function(a){this.$element=a;if(this.dateValue=c(a).data("countdown"))this.dateValue=this.dateValue.replace(/-/g,"/"),this.dateValue=Math.round((new Date(this.dateValue)).getTime()/1E3),this.start()},start:function(){var a=this.dateValue-Math.round((new Date).getTime()/
